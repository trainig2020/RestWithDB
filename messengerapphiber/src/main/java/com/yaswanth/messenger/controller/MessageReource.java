package com.yaswanth.messenger.controller;
...
import com.yaswanth.messenger.exception.DataNotFoundException;
import com.yaswanth.messenger.model.Link;
import com.yaswanth.messenger.model.Message;
import com.yaswanth.messenger.service.MessageService;
...
public class MessageReource {
	...
	public Response getMessId(@PathParam("messageId") int messageId,@Context UriInfo uriInfo) {
		...
		return Response.status(Status.OK).entity(med).build();
		}
